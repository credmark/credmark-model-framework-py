    ...
    def test_ledger_txn(self):
        ...
        with context.ledger.Transaction as oo:
            ...
            df = oo.select(
                columns=oo.columns,
                where=(
                    oo.HASH.gt('0x972a0eb7442f2d9393b0fa165eed419e3b9d142fab2d6803b8bcf45719d261de').and_(
